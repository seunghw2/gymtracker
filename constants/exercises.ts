...
export const MACHINE_BRANDS = ['Hammer Strength', 'Panatta', 'Nautilus', 'Life Fitness', 'Focus', 'Cybex', 'Newtech', 'M-Torture', 'Precor', 'Prime', 'Arsenal', 'FreeMotion', 'Booty Builder', 'Drax', '기타'] as const;
